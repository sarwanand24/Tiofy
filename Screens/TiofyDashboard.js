        ...
        <ScrollView contentContainerStyle={{ paddingBottom: 50 }}>
          ...
          <View style={styles.categoriesContainer}>
            <TouchableOpacity style={styles.categoryItem} onPress={() => { props.navigation.push('FoodDashboard') }}>
              <Icon name="fast-food-outline" size={40} color="#0044FF" />
              <Text style={styles.categoryText}>Food</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.categoryItem}>
              <Icon name="bed-outline" size={40} color="#0044FF" />
              <Text style={styles.categoryText}>Hotel</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.categoryItem} onPress={() => { props.navigation.push('Signup') }}>
              <Icon name="car-outline" size={40} color="#0044FF" />
              <Text style={styles.categoryText}>Cab</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.categoryItem}>
              <FontAwesome6 name="scissors" size={40} color="#0044FF" />
              <Text style={styles.categoryText}>Saloon</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.categoryItem}>
              <Icon name="leaf" size={40} color="#0044FF" />
